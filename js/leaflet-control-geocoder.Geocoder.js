(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.leafletControlGeocoder = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(dereq,module,exports){
			...
			_createAlt: function(result, index) {
				var li = L.DomUtil.create('li', ''),
					...
					mouseDownHandler = function mouseDownHandler(e) {
						...
						// wait until the click is completed, and then collapse the
				...
				// Use mousedown and not click, since click will fire after blur,
	...
	},{"./geocoders/nominatim":9}],2:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],3:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],4:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],5:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],6:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],7:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],8:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],9:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],10:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],11:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Util = dereq('../util');
	...
	},{"../util":13}],12:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		Control = dereq('./control'),
		Nominatim = dereq('./geocoders/nominatim'),
		Bing = dereq('./geocoders/bing'),
		MapQuest = dereq('./geocoders/mapquest'),
		Mapbox = dereq('./geocoders/mapbox'),
		What3Words = dereq('./geocoders/what3words'),
		Google = dereq('./geocoders/google'),
		Photon = dereq('./geocoders/photon'),
		Mapzen = dereq('./geocoders/mapzen'),
		ArcGis = dereq('./geocoders/arcgis'),
		HERE = dereq('./geocoders/here');
	...
	},{"./control":1,"./geocoders/arcgis":2,"./geocoders/bing":3,"./geocoders/google":4,"./geocoders/here":5,"./geocoders/mapbox":6,"./geocoders/mapquest":7,"./geocoders/mapzen":8,"./geocoders/nominatim":9,"./geocoders/photon":10,"./geocoders/what3words":11}],13:[function(dereq,module,exports){
	(function (global){
	var L = (typeof window !== "undefined" ? window['L'] : typeof global !== "undefined" ? global['L'] : null),
		lastCallbackId = 0,
		htmlEscape = (function() {
	...
	module.exports = {
		jsonp: function(url, params, callback, context, jsonpParam) {
			var callbackId = 'l_geocoder' + (lastCallbackId++);
